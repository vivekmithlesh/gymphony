-- ============================================================
-- APPLY_NOW.sql — run this once in the Supabase SQL Editor.
-- Combines the migrations the AI messaging + check-in features
-- need, in dependency order. Safe to re-run.
-- ============================================================

-- ---- 1/3: check_ins table + RLS --------------------------------
-- =============================================================================
...
-- ---- 3/3: conversations + messages refactor --------------------
-- =============================================================================
